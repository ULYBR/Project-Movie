    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('Acao', 'Ação'), ('Anime', 'Anime'), ('Aventura', 'Aventura'), ('Comedia', 'Comédia'), ('Documentario', 'Documentário'), ('Infantil', 'Infantil'), ('Romance', 'Romance'), ('Terror', 'Terror')], max_length=16)),
